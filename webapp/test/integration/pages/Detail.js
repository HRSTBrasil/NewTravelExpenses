						...
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("externalCode");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.externalCode === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<cust_toExpenseItemsPlural> (" + iNumberOfItems + ")"}),
								success : function () {
